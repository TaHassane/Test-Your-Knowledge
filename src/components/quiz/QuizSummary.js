...
// Create a wrapper component using function component syntax
function QuizSummaryWrapper(props) {
    const location = useLocation();
    const { user } = useAuth();
    return <QuizSummary location={location} user={user} {...props} />;
}
...
// Export the wrapper component instead of the HOC
